...
public class UtilPropGiri {
   ...
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\14022\\eclipse-workspace\\workspaceCSCI4830-ex-0128-giri\\webproject-ex-0128-giri\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/webproject-ex-0128-giri/config.properties";
